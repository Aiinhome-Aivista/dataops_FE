  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F9FAFB]">
      <div className="w-full max-w-sm bg-white border border-[#E5E7EB] rounded-2xl p-8 shadow-sm">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-[#111827]">DataOps Orchestrator</h1>
          <p className="text-sm text-[#6B7280] mt-1">Sign in to continue</p>
        </div>
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label className="block text-xs uppercase tracking-wide text-[#6B7280] mb-1">Email</label>
            <input
              type="email"
              required
              value={email}
          ...
          <div>
            <label className="block text-xs uppercase tracking-wide text-[#6B7280] mb-1">Password</label>
            <input
              type="password"
              required
              value={password}
